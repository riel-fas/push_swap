...
void populate_stack_A(t_stack_node **a, char **av); // Populate stack A
...
// Functions for performing operations on stacks
void sa_sb(t_stack_node **stack);  // Swap the top two elements of stack A or B
void ra_rb(t_stack_node **stack);  // Rotate the stack (move top element to bottom)
void rra_rrb(t_stack_node **stack); // Reverse rotate the stack (move bottom element to top)
